        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-6">
              Connect with fellow diggers, share your creations, and get help from experienced players in our thriving
              community.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a
                href="https://steamcommunity.com/app/3244220"
                target="_blank"
                rel="noopener noreferrer"
                className="block"
              >
                <Button className="w-full bg-[#1b2838] hover:bg-[#2a475e]">
                  <svg
                    className="w-5 h-5 mr-2"
                    fill="currentColor"
                    viewBox="0 0 24 24"
              ...
              <a
                href="https://www.reddit.com/r/gamedev/comments/1it87zo/what_is_unique_about_a_game_about_digging_a_hole/"
                target="_blank"
                rel="noopener noreferrer"
                className="block"
              >
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <div className="flex items-center mb-1">
                    <span className="font-bold mr-2">DigMaster42</span>
                    <span className="text-gray-500 text-sm">2 days ago</span>
                  </div>
                  <p className="text-gray-600 mb-2">
                    Just reached 100 meters depth in my main hole! Check out this amazing crystal formation I found.
                  </p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <div className="flex items-center mb-1">
                    <span className="font-bold mr-2">ShovelQueen</span>
                    <span className="text-gray-500 text-sm">5 days ago</span>
                  </div>
                  <p className="text-gray-600 mb-2">
                    I created a spiral staircase in my hole! Took me 8 hours but totally worth it. Here's a tutorial on
