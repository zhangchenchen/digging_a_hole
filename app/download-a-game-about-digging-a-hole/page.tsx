  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-100 to-green-100 pt-20">
      <div className="container py-12">
        <h1 className="text-4xl font-bold mb-8">Download A Game About Digging A Hole</h1>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-600 ml-4">
                <li>
                  Purchase and download A Game About Digging A Hole from the{" "}
                  <a
                    href="https://store.steampowered.com/app/3244220/A_Game_About_Digging_A_Hole/"
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
                ...
                <li>Contact our support team through our social media channels.</li>
              </ul>
            </div>
          </div>
        </div>
