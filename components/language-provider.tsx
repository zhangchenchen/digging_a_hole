...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.conclusion": "Whether you have five minutes or five hours, this game provides a meditative escape from the complexities of modern gaming and everyday life.",
    "features.title": "Features",
    "gameplay.title": "See the Game in Action",
    "gameplay.video1": "Getting Started - Beginner's Guide",
    "gameplay.video2": "Discovering Underground Treasures",
    "gameplay.video3": "Digging Techniques & Tool Usage",
    "gameplay.video4": "Exploring Mysterious Caves",
    "gameplay.video5": "Collaborative Digging with Other Players",
    "gameplay.video6": "Creating the Perfect Hole",
  ...
  zh: {
    ...
    "about.conclusion": "无论您有五分钟还是五小时，这款游戏都能让您从现代游戏和日常生活的复杂性中获得冥想式的逃离。",
    "features.title": "特点",
    "gameplay.title": "游戏实况",
    "gameplay.video1": "开始挖掘 - 新手指南",
    "gameplay.video2": "发现地下宝藏",
    "gameplay.video3": "挖掘技巧与工具使用",
    "gameplay.video4": "探索神秘洞穴",
    "gameplay.video5": "与其他玩家合作挖掘",
    "gameplay.video6": "创建完美的洞穴",
  ...
  ja: {
    ...
    "about.conclusion": "5分でも5時間でも、このゲームは現代のゲームや日常生活の複雑さから瞑想的な逃避を提供します。",
    "features.title": "特徴",
    "gameplay.title": "ゲームプレイ映像",
    "gameplay.video1": "はじめてのプレイ - 初心者ガイド",
    "gameplay.video2": "地下の宝物を発見する",
    "gameplay.video3": "掘削テクニックとツールの使用法",
    "gameplay.video4": "神秘的な洞窟の探索",
    "gameplay.video5": "他のプレイヤーとの協力掘削",
    "gameplay.video6": "完璧な穴を作る",
  ...
  ko: {
    ...
    "about.conclusion": "5분이든 5시간이든, 이 게임은 현대 게임과 일상 생활의 복잡함에서 벗어나 명상적인 탈출구를 제공합니다.",
    "features.title": "특징",
    "gameplay.title": "게임 플레이 영상",
    "gameplay.video1": "시작하기 - 초보자 가이드",
    "gameplay.video2": "지하 보물 발견하기",
    "gameplay.video3": "파기 기술 및 도구 사용법",
    "gameplay.video4": "신비한 동굴 탐험하기",
    "gameplay.video5": "다른 플레이어와 함께 파기",
    "gameplay.video6": "완벽한 구멍 만들기",
  ...
  fr: {
    ...
    "about.conclusion": "Que vous ayez cinq minutes ou cinq heures, ce jeu offre une évasion méditative de la complexité des jeux modernes et de la vie quotidienne.",
    "features.title": "Caractéristiques",
    "gameplay.title": "Voir le Jeu en Action",
    "gameplay.video1": "Premiers Pas - Guide du Débutant",
    "gameplay.video2": "Découverte des Trésors Souterrains",
    "gameplay.video3": "Techniques de Creusement et Utilisation d'Outils",
    "gameplay.video4": "Exploration des Grottes Mystérieuses",
    "gameplay.video5": "Creusement Collaboratif avec d'Autres Joueurs",
    "gameplay.video6": "Création du Trou Parfait",
  ...
  es: {
    ...
    "about.conclusion": "Ya sea que tengas cinco minutos o cinco horas, este juego proporciona un escape meditativo de la complejidad de los juegos modernos y la vida cotidiana.",
    "features.title": "Características",
    "gameplay.title": "Ver el Juego en Acción",
    "gameplay.video1": "Primeros Pasos - Guía para Principiantes",
    "gameplay.video2": "Descubriendo Tesoros Subterráneos",
    "gameplay.video3": "Técnicas de Excavación y Uso de Herramientas",
    "gameplay.video4": "Explorando Cuevas Misteriosas",
    "gameplay.video5": "Excavación Colaborativa con Otros Jugadores",
    "gameplay.video6": "Creando el Hoyo Perfecto",
